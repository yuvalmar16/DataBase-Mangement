...
------àé àôùø ìååãà ùîòáéøéí á÷ùä ùëáø àåùøä.



create table MoveRequest
(
    --ðéñéðå ìëúåá àçøé ùäâãøðå àú îðäì ôòîééí ëîôúç æø On delete cascade àê æä ìà äúàôùø îáçéðú äddl
...
--ëàï éù àú îåòãé äöôééä áëì äòøåöéí ùáàåúå îîéø. ääðçä ùìðå ùéùîøå äòøåöéí ùàéðí ðöôå
-- òì éãé äì÷åç àê ðîöàéí áîîéø ùìå
---åäswitchingTime ùìäí éùîø ënull
